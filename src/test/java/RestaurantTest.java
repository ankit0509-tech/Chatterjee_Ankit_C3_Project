...
// ADDED METHOD ABOVE TO RETURN RESTAURANT IF TIME IS BETWEEN OPENING AND CLOSING TEAM
    ...
    public void return_order_value_of_selected_menu() {
        ...
        assertEquals(269, restaurant.displayTotalOrderValue(menu));

    }

    @Test
    public void return_zero_value_when_no_item_is_selected_from_menu() {
        List<String> menu = new ArrayList<String>();
